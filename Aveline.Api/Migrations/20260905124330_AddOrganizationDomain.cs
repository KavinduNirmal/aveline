        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationRole = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClerkOrgId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoutiqueRole = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationInvitations_Users_RecipientUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationInvitations_OrganizationId_AcceptedAt",
                table: "OrganizationInvitations",
                columns: new[] { "OrganizationId", "AcceptedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationInvitations_RecipientUserId",
                table: "OrganizationInvitations",
